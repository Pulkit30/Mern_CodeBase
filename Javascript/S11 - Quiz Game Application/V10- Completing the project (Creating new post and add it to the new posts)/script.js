...
// Add Event listeners to listen to the submit event of the form.
 postForm.addEventListener("submit", (event) => {
        ...
        const newPost = {
            ...
            author: "You", // You can modify this to get the actual user's name
            content: content,
            likes: 0,
            comments: [],
            image: imageFile ? URL.createObjectURL(imageFile) : "https://via.placeholder.com/150", // Placeholder if no image
        };

        postsData.push(newPost); // Add the new post to the beginning
